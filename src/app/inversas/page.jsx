...
export default function InversasPage() {
  ...
  return (
    <div className="flex flex-col text-black">
      <h1 className="text-3xl font-bold">Funciones Inversas</h1>
      <hr />
      <input ref={expresion} type="text" name="expresion" id="exp" onChange={handleTitleChange}/>
      <MathJax>{`$ ${exp} $`}</MathJax>
